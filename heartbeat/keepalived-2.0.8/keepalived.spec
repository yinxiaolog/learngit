...
#CONFIG_OPTS="$CONFIG_OPTS --enable-snmp-vrrp"
#CONFIG_OPTS="$CONFIG_OPTS --enable-snmp-checker"
#CONFIG_OPTS="$CONFIG_OPTS --enable-snmp-rfc"
#CONFIG_OPTS="$CONFIG_OPTS --enable-snmp-rfcv2"
#CONFIG_OPTS="$CONFIG_OPTS --enable-snmp-rfcv3"
CONFIG_OPTS="$CONFIG_OPTS --disable-snmp-reply-v3-for-v2"
#CONFIG_OPTS="$CONFIG_OPTS --enable-sha1"
#CONFIG_OPTS="$CONFIG_OPTS --enable-dbus"
CONFIG_OPTS="$CONFIG_OPTS --with-init=systemd"
#CONFIG_OPTS="$CONFIG_OPTS --enable-regex"
